import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, computed, h, toValue, getCurrentInstance, onServerPrefetch, mergeProps, unref, createVNode, resolveDynamicComponent, inject, provide, hasInjectionContext, ref, watch, withCtx, renderSlot, openBlock, createBlock, toDisplayString, shallowRef, cloneVNode, createElementBlock, toRef as toRef$1, isRef, resolveComponent, useModel, createTextVNode, createCommentVNode, mergeModels, nextTick, useAttrs, useTemplateRef, reactive, defineAsyncComponent, toRefs, useSSRContext, shallowReactive, Suspense, Fragment, createApp, readonly, customRef, renderList, useId, onErrorCaptured, effectScope, useSlots, withModifiers, getCurrentScope, isReadonly, isShallow, isReactive, toRaw, markRaw } from 'vue';
import { W as serialize, X as defu, o as createError$1, Y as klona, Z as headSymbol, x as joinURL, _ as withQuery, $ as useHead$1, a0 as parseQuery, a1 as defuFn, a2 as hasProtocol, Q as parseURL, a3 as encodePath, a4 as decodePath, a5 as getContext, a6 as isScriptProtocol, K as withTrailingSlash, a7 as withoutTrailingSlash, a8 as sanitizeStatusCode, a9 as withLeadingSlash, aa as $fetch$1, ab as baseURL, ac as resolveUnrefHeadInput, ad as createHooks, ae as isEqual, af as executeAsync, b as getHeader, ag as titleCase, ah as encodeParam, s as setCookie, ai as camelCase, aj as toRouteMatcher, ak as createRouter$1, al as withoutBase, am as useSeoMeta$1, an as stringifyQuery, ao as withBase, ap as parse$1, aq as getRequestHeader, t as destr, ar as getCookie, as as deleteCookie } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BNH_PInZ.mjs')
  },
  {
    name: "about",
    path: "/about",
    component: () => import('./index-DzpBeuVA.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./index-B00obsUt.mjs')
  },
  {
    name: "admin-login",
    path: "/admin/login",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./login-DMGV90Cs.mjs')
  },
  {
    name: "collections-id",
    path: "/collections/:id()",
    component: () => import('./_id_-B4-Ax1fI.mjs')
  },
  {
    name: "collections",
    path: "/collections",
    component: () => import('./index-B6kvrTo_.mjs')
  },
  {
    name: "admin-products-id",
    path: "/admin/products/:id()",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./_id_-BWXNZEO8.mjs')
  },
  {
    name: "admin-products",
    path: "/admin/products",
    meta: __nuxt_page_meta || {},
    component: () => import('./index-BIUsUM6Y.mjs')
  }
];
...
const ipxRuntime$jQDgJBTC9nCIVCWMq8cHXXFTvXY9eMdgDjkVmBB_45UiE = defineProvider({
...
const imageOptions = {
  ...
  provider: "ipx",
  providers: {
    ["ipx"]: { setup: ipxRuntime$jQDgJBTC9nCIVCWMq8cHXXFTvXY9eMdgDjkVmBB_45UiE, defaults: {} }
  }
};
...
const layouts = {
  admin: defineAsyncComponent(() => import('./admin-DqhTeLng.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-jbd0Oj5H.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-C2LqGkWz.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BMOkmWey.mjs'));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-hqrXPOh3.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
    nuxtApp.deferHydration();
...
export { __nuxt_component_0$1 as A, useSiteConfig as B, _export_sfc as _, __nuxt_component_0$2 as a, isDef as b, createError as c, useAsyncData as d, entry_default as default, _sfc_main$e as e, useAppConfig as f, useFormField as g, useFieldGroup as h, injectHead as i, useComponentIcons as j, _sfc_main$b as k, looseToNumber as l, useSchemaOrg as m, useRuntimeConfig as n, useNuxtApp as o, useRoute as p, useOgImageRuntimeConfig as q, getOgImagePath as r, setHeadOgImagePrebuilt as s, tv as t, useHead as u, useRequestEvent as v, createOgImageMeta as w, __nuxt_component_2$1 as x, useDebounceFn as y, useState as z };
